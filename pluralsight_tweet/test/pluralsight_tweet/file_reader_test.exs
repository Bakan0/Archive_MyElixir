defmodule FileReaderTest do
    ...
    test "An empty string should return an empty string [from OUTSIDE mock f(x)]" do
        with_mock File, [read!: fn(_) -> "lolfake.txt" end] do
          str = pick_string("")
        assert str == ""
        end
    end

    test "The string should be trimmed [from mock f(x)]" do
